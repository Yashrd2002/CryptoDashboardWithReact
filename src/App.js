...
export default class App extends Component {
  ...
  render() {
    return (
      <div>
        <Navbar handle_Submit = {this.handleSubmit} />
        <Card coinName={this.state.Data.name} currentPrice={this.state.Data.market_data ? this.state.Data.market_data.current_price["usd"] : ""}
